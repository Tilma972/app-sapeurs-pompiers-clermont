      ...
      <PwaContainer>
        <div className="flex items-center justify-center min-h-[50vh]">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Chargement de la vie associative...</p>
          </div>
        </div>
      </PwaContainer>
    );
    ...
    <PwaContainer>
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold">Vie Associative</h1>
            <p className="text-sm text-muted-foreground">Événements & organisation</p>
          </div>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-4">
            ...
            <TabsTrigger value="naissances" className="flex items-center gap-2">
              <Baby className="w-4 h-4" />
              <span className="hidden sm:inline">Naissances</span>
            </TabsTrigger>
            <TabsTrigger value="materiel" className="flex items-center gap-2">
          ...
          <TabsContent value="naissances" className="space-y-4">
            {naissances.map((naissance) => (
              <Card key={naissance.id}>
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-pink-100 dark:bg-pink-900/20 rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="flex-1">
                      ...
                      {naissance.message && (
                        <p className="text-sm italic bg-pink-50 dark:bg-pink-900/10 p-3 rounded-lg border border-pink-200 dark:border-pink-800">
                          &quot;{naissance.message}&quot;
                        </p>
                      )}
                    </div>
                ...
                <Card key={materiel.id}>
                  <CardContent className="p-4">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <h3 className="font-semibold">{materiel.nom_materiel}</h3>
                        <p className="text-sm text-muted-foreground mt-1">{materiel.description}</p>
                      </div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      {!materiel.disponible && (
                        <div className="bg-orange-50 dark:bg-orange-900/10 border border-orange-200 dark:border-orange-800 rounded p-2 mt-3">
              ...
              <Card key={info.id} className={`border-l-4 ${getPrioriteColor(info.priorite)}`}>
                <CardContent className="p-4">
                  <div className="flex items-start justify-between mb-2">
                    <h3 className="font-semibold">{info.titre}</h3>
                    <Badge variant="outline" className={getPrioriteColor(info.priorite)}>
                      {info.priorite}
                    </Badge>
                  </div>
                  <p className="text-sm mb-3">{info.contenu}</p>
