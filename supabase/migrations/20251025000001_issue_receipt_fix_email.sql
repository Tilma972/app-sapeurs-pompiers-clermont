-- Fix issue_receipt: stop referencing non-existent donor_email on support_transactions
-- Use supporter_email only; keep function signature and behavior unchanged
